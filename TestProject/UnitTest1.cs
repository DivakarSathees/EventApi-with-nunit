...
namespace EventApi.Tests
{
    public class EventApiControllerTests
    {
        ...
        public void Setup()
        {
            ...
            _context.EventApis.AddRange(new List<EventApi.Models.EventApi>
            {
                new EventApi.Models.EventApi { Id = 1, Event_Name = "Event 1", Event_Type = "Type A", Start_Date = new DateTime(2023, 4, 20), End_Date = new DateTime(2023, 4, 25), Location = "Location A" },
                new EventApi.Models.EventApi { Id = 2, Event_Name = "Event 2", Event_Type = "Type B", Start_Date = new DateTime(2023, 5, 1), End_Date = new DateTime(2023, 5, 5), Location = "Location B" },
                new EventApi.Models.EventApi { Id = 3, Event_Name = "Event 3", Event_Type = "Type C", Start_Date = new DateTime(2023, 6, 1), End_Date = new DateTime(2023, 6, 5), Location = "Location C" }
            });
        ...
        [Test]
        public async Task GetEventApis_ReturnsAllEvents()
        {
            var result = await _controller.GetEventApis();

            Assert.IsInstanceOf(typeof(List<EventApi.Models.EventApi>), result.Value);
            Assert.AreEqual(3, result.Value.Count());
        }

    
        [Test]
        public async Task GetEventApi_InvalidId_ReturnsNotFound()
        {
            int eventId = 100;
        ...
        [Test]
        public async Task GetEventApi_ReturnsSingleEvent()
        {
            int eventId = 2;

            var result = await _controller.GetEventApi(eventId);

            Assert.IsInstanceOf(typeof(EventApi.Models.EventApi), result.Value);
            Assert.AreEqual(eventId, result.Value.Id);
        }

        [Test]
        public async Task DeleteEventApi_DeletesExistingEvent()
        {
            int eventId = 1;
         ...
         [Test]
        public async Task PostEventApi_WithValidData_ReturnsCreatedAtActionResult()
        {
            var testEventApi = new EventApi.Models.EventApi {Id = 4 ,Event_Name = "Event 4", Event_Type = "Type D", Start_Date = new DateTime(2023, 7, 1), End_Date = new DateTime(2023, 7, 5), Location = "Location D" };
        ...
        [Test]
        public async Task PostEventApi_WithValidData_ReturnsCreatedEventApi()
        {
            var testEventApi = new EventApi.Models.EventApi { Id = 5 ,Event_Name = "Event 5", Event_Type = "Type D", Start_Date = new DateTime(2023, 7, 1), End_Date = new DateTime(2023, 7, 5), Location = "Location D"  };
            ...
            var createdEventApi = createdResult.Value as EventApi.Models.EventApi;
